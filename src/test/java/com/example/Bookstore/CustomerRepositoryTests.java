...
public class CustomerRepositoryTests {
    ...
    @Test
    public void findByUsernameShouldReturnCustomer() {
    ...
    public void createCustomer() {
    	Customer customer = new Customer("chandlerbing", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "CUSTOMER", "chandler.bing@gmail.com");
